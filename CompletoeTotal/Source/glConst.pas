...
const
  ...
  EVENT_RESOLUTION = 'Resolução da janela: %dx%d.';
  ...
  ERROR_EXISTS = '%s já existente.';
  ERROR_REGISTRY = 'Impossível registrar classe %s.';
  ERROR_INSTANCE = 'Impossível instanciar classe %s.';
  ...
  MSG_BOXEXIT = 'Você realmente deseja sair?';
  MSG_BOXSAVE = 'Deseja salvar as alterações em %s?';
